...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#10a3e7 0%,#0aa9ff 60%,#0c89dd 100%);
            padding:3rem 2rem 2.5rem;margin:-1rem -1rem 2rem;text-align:center;">
    <div style="font-size:14px;font-weight:500;color:rgba(1, 2, 2, 0.847);
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#6dd2fd;border:1px solid #6fbeef;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#f2a10a;color:white;border-radius:8px;
    ...
    <div style="background:#00e1ff;border:1px solid #06f6f2;border-radius:14px;
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            ...
            <span style="font-size:16px;font-weight:600;color:#000000;">How long have you had these symptoms?</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <!-- COLOR6 -->
    <div style="background:#09e2f6;border:1px solid #00c8ff;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#f2a90a;color:rgb(0, 0, 0);border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">5</span>
            <span style="font-size:16px;font-weight:600;color:#000000;">Patient Information</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
